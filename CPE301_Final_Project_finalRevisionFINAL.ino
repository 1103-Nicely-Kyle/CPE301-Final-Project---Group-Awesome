...
bool idleStateAlreadyPrinted = false;
...
void loop()
{
  ...
  while(start == true){
    ...
    if(temperature < 21){
      ...
      if(idleStateAlreadyPrinted != false){
        Serial.print("State = Idle\n"); 
        Serial.print(hour(), DEC);
        Serial.print(':');
        Serial.print(minute(), DEC);
